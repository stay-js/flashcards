...
export const setsRouter = router({
  getAllPublic: publicProcedure
    .input(z.object({ query: z.string(), category: z.string() }))
    .query(({ ctx, input }) => {
      type Query = {
        visibility: 'PUBLIC';
      ...
      let query: Query = { visibility: 'PUBLIC' as const };
      if (input.query !== '') query = { ...query, name: { contains: input.query } };
      if (input.category !== 'All') query = { ...query, category: input.category };
